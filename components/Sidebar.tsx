...
export const Sidebar: React.FC<SidebarProps> = ({ activeView, setActiveView, onOpenSettings }) => {
    ...
    return (
        <div className="hidden md:flex flex-col w-64 h-screen sticky top-0 p-4 border-r border-premium-border bg-black/40 backdrop-blur-xl">
            {/* Logo Area */}
            <div className="flex items-center justify-center px-4 pb-8 pt-2 relative group/logo">
                ...
                <img src="/bulllogo.svg" alt="Paper Trader" className="h-16 w-auto object-contain drop-shadow-[0_0_25px_rgba(212,175,55,0.3)] transition-transform duration-500 relative z-10" />
            </div>
